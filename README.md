...
**Android firmware engineer & open-source tool maker.** I build tools that run on Android, for Android — no PC needed.
...
All repos are open-source. [Open an issue](https://github.com/soe1hom-arch/AFFT/issues) or submit a PR — any level welcome.
